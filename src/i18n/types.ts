...
export interface MatchMakerTranslations {
  ...
  baseLabel: string;
  baseHint: string;
  maxMatchesLabel: string;
  maxMatchesHint: string;
  roundProgressLabel: string;
  roundProgressUnlimited: string;
  roundsLeftHint: string;
  limitReached: string;
  barMaxOf: string;
  barMaxOpen: string;
  countMinusAria: string;
  countPlusAria: string;
  adjustCountTitle: string;
  adjustCountBody: string;
  btnConfirmAdjustCount: string;
  adjustCountSaving: string;
  errorAdjustCount: string;
